      ...
      <ul className="mb-10 flex flex-wrap justify-evenly gap-x-10 gap-y-10">
        ...
        >
          <p className="indent-5">
            {`Fundada em 2021 na cidade de Anápolis, Goiás, por Guilherme Moura Cardoso, a Smart Cooling é uma empresa especializada na venda, instalação e manutenção de equipamentos de ar-condicionado e energia solar.`}
          </p>
          <p className="indent-5">
